...
struct CmCardRecord
{
    ...
    // Card background opacity, as a percentage. -1 = inherit the general
    // "widget opacity" from CmConfig; 0..100 overrides it for this card only.
    // Same -1-inherit idiom as showTitle.
    int opacity = -1;
