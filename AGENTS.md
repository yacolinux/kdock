...
- **Config por instancia**, en su propio grupo del `.conf` del dock: `[appsel1] apps=…` (los
  `.desktop` que dibuja, o sea su "pinned") y `onlyPinned` (**default true**). El nombre sale del
