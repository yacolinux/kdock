...
- **Estado**: instalado y en uso desde el 2026-08-05, probado en la sesión real sin bugs conocidos. Lo único que quedó sin ejercitar es el cruce **entre monitores** (que atar un dock a un escritorio en un monitor no toque a los otros): la lógica está separada por pantalla y las sondas cubren el agrupamiento, pero al momento de escribir esto había un solo output conectado y Xvfb no da una segunda pantalla.
