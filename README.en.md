...
or the CLI. The result is four standalone binaries, no plugins to install, and no need to
...
cmake --build build -j
sudo cmake --install build     # installs the four binaries and their .desktop files
```
